...
arguments.length-1},"class":function(c){c.className=a.args(arguments,1).join(" ")},update:function(c){for(var b=c,g=1;g<arguments.length;g++){var d=arguments[g],e,h;if(a.is_node(d))c.appendChild(d);else if("string"===typeof d||"number"===typeof d)c.appendChild(document.createTextNode(d));else if(d instanceof Array)for(e=0;e<d.length;e++)f.update(c,d[e]);else if("function"===typeof d)if(d.hasOwnProperty("dom")&&a.is_node(d.dom))c.appendChild(d.dom);else if("binding"===d.name)e=document.createTextNode(d()),
d.register(function(a){this.nodeValue=a},e),c.appendChild(e);else throw"Not a DOM node";else for(h in"object"===typeof d&&d.hasOwnProperty("context")&&(b=d.context),d)if(d.hasOwnProperty(h)){var i=d[h];if("context"!==h)if("class"===h||"cls"===h)i&&(e=i.split(/\s+/),e=a.filter(e.concat(c.className.split(/\s+/))),c.className=e.join(" "));else if("style"===h)f.css(c,i);else if(/^on/.test(h)){e=h.slice(2);var j=i,k=[],l=b,m=!1;"function"!==typeof i&&(j=i.func,k=i.args||k,l=i.context||l,m=i.capture||m);
i=l!==c;if(0!==k.length)var o=j,j=function(){o.apply(l,k.concat(a.args(arguments)))};else i&&(o=j,j=function(){o.apply(l,arguments)});c.addEventListener(e,j,m)}else c.setAttribute(h,i)}}}}})(dominate);
...
(function(e){var a=e.utils,f=e.io={xhr:function(a,b,g,d,e){var e=e||null,f=new XMLHttpRequest;f.open(a,b,!0);f.addEventListener("readystatechange",function(a){4===f.readyState&&d.call(e,f.responseText,f,a)});f.send(g)},get:function(a,b,e){f.xhr("GET",a,null,b,e)},post:function(a,b,e,d){f.xhr("POST",a,b,e,d)},form:function(c){var b=new FormData;a.foreach(c,function(a,d){b.append(d,a)});return b}}})(dominate);
