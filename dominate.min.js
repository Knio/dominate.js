...
(function(e){var a=e.tag_names="a address article aside audio blockquote br button canvas caption code col colgroup dd div dl dt em fieldset figure footer form h1 h2 h3 h4 h5 h6 header hgroup hr img input label legend li link main math nav ol optgroup option output p pre progress script section select small source span strong style sub sup table tbody td template textarea tfoot th thead time tr ul video".split(" "),f=e.html,b=e.utils,c=e.tags={};c.text=function(a){return document.createTextNode(""+
a)};c.create_tag=function(a){c[a]=function(){var d=document.createElement(a);f.update.apply(this,[d].concat(b.args(arguments)));return d}};b.foreach(a,c.create_tag)})(dominate);
